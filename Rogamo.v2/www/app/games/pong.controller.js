(function () {
    ...
    PongGameController.$inject = ['$scope', '$timeout', '$ionicPopover', 'PongGame', 'RobotEngine', 'GameEngine'];

    function PongGameController($scope, $timeout, $ionicPopover, game, robot, gameEngine) {
      var vm = this,
          gameStartPromise,
          startDate;
